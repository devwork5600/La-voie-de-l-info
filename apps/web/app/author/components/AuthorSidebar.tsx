...
import { LayoutDashboard, Newspaper, Plus } from "lucide-react";
...
const MENU_ITEMS = [
  ...
  { href: "/author/articles", label: "Mes articles", icon: Newspaper },
  { href: "/author/create-article", label: "Nouvel article", icon: Plus },
];
